      ...
      <form action = "updatePayment" method = "post">
        ...
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="text" placeholder="Enter staff member username" name="paidTo" value="<%=pay.getPaidTo() %>" pattern="^[a-zA-Z]([._](?![._])|[a-zA-Z0-9]){3,18}[a-zA-Z0-9]$" title="Must contain at least five characters, begin with a letter and can contain only letters, numbers, period and underscore" required>
          </div>
          <div class="input-box">
            <span class="details">By</span>
            <input type="text" placeholder="Enter manager username" value="<%=pay.getPaidBy() %>" name="paidBy" pattern="^[a-zA-Z]([._](?![._])|[a-zA-Z0-9]){3,18}[a-zA-Z0-9]$" title="Must contain at least five characters, begin with a letter and can contain only letters, numbers, period and underscore" required>
          </div>
          <div class="input-box">
